...
OXE_DATASET_CONFIGS = {
   ...
   "droid_100": {
    ...
    ### CUSTOMS
    "dexformer_dataset": {  # "grip water bottle in bowl" task, 50 demos @ ? Hz control
        "image_obs_keys": {"primary": "front_view", "secondary": "top_view", "wrist": "wrist_view"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["qpos"],
        "state_encoding": StateEncoding.HAND_ARM,
        "action_encoding": ActionEncoding.HAND_ARM,
    },
}
